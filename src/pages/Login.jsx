  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="font-display text-2xl font-bold text-navy-700 mb-1">Campus Marketplace</h1>
        <p className="text-navy-400 text-sm mb-6">Log in with your student email.</p>
        ...
        <p className="text-sm text-navy-400 mt-4">
          New here?{" "}
          <Link to="/register" className="text-navy-600 font-medium underline">Create an account</Link>
        </p>
      </div>
    </div>
  );
