  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 dark:bg-navy-900 transition-colors">
      <div className="w-full max-w-sm">
        ...
        <p className="text-navy-500 dark:text-navy-200 text-sm mb-6">Use your student email so buyers know you&apos;re verified.</p>
        ...
        <p className="text-sm text-navy-500 dark:text-navy-200 mt-4">
